...
static inline void avx512_fv_load(avx512_fv_t *dst, scalar_t *src)
{
	*dst = _mm512_loadu_ps(src); \
}

static inline void avx512_fv_load1(avx512_fv_t *dst, scalar_t val)
{
	*dst = _mm512_set1_ps(val);
}

static inline void avx512_fv_store(scalar_t *dst, avx512_fv_t *src)
{
...
static inline scalar_t avx512_fv_reduce_sum(avx512_fv_t *lhs)
{
...
static inline scalar_t avx512_fv_reduce_max(avx512_fv_t *lhs)
{
